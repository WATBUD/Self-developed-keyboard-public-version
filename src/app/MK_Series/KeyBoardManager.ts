...
export class KeyBoardManager {
    ...
    constructor(inputmax) {
        this.KeyBoardArray = [
            new KeyBoard("硬體配置1", inputmax),
            new KeyBoard("硬體配置2", inputmax),
            new KeyBoard("硬體配置3", inputmax),
            new KeyBoard("硬體配置4", inputmax),
        ]
...
export class KeyBoard {
    ...
    getNowModeTargetMatrixKey(){
        ...
        if(target!=undefined){
         ...
         console.log("%c getNowModeTargetMatrixKey_lost","color:red",this.getNowModeKeyMatrix(),this.recordAssignBtnIndex);
        }
    }
