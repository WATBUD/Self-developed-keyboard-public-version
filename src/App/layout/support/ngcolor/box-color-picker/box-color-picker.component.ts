...
@Component({
    ...
    styleUrls: ['./components/layout/support/ngcolor/box-color-picker/box-color-picker.component.css'],
    templateUrl: './components/layout/support/ngcolor/box-color-picker/box-color-picker.component.html',
    providers: [
        {
