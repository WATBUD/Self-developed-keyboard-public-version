...
export class MouseMoveObject {
     ...
     constructor(setTargetName) {
        ...
        //console.log('SharesFunctionSharesFunctionSharesFunctionSharesFunction_',SharesFunction);
        //  this.SharesFn = new SFjs.SharesFunction();
     ...
     addMoveMouseEvent() {
         ...
         this.eventArray[1] = (event) => {
             ...
             var T3 = getElementCSS(this.ScrollContentArea, "width");
             //SharesFn.get_Windows_Vw_Vh()[0]*50;
             var T5 =getElementCSS(this.ScrollContentArea, "height");
             ...
             this.ScrollArea.addEventListener("scroll", function (event) {
             ...
             var obj = {
                 ...
                 "T4": T4,
                 "T5": T5,
                 "ScrollArea.scrollTop": this.ScrollArea.scrollTop,
                 "ScrollArea.scrollLeft": this.ScrollArea.scrollLeft,
                 //   "document.style.":document.style,      
             };
