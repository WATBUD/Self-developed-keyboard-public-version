...
export class CurrentColor{    
        ...
        SBgColor:any="";
        VBgColor:any="";
        preDefineColor=["#FF2000","#ff8000","#80ff00","#00ff00","#00ffff","#0000ff","#8000ff","#ff00ff","#ff0080","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"];//RGB
        ...
        mousedown(oEvent: MouseEvent) {
            ...
            // this.customlog("oEvent.clientX"+oEvent.clientX+"oEvent.clientY"+oEvent.clientY);
            // this.customlog("設定位置","disX"+disX,"disY"+disY,"resultleft"+resultleft,"resultTop"+resultTop);
        ...
        showColorVarData() {
            ...
            this.customlog('showColorVarData',colorlog);
        }
        ...
        setS_RGBColor(){
            ...
            var arr=this.HSVtoRGB(this.Hue/360, 1, this.Value/100);
            this.SBgColor="-webkit-linear-gradient(left,#ffffff," +
            "rgb(" + arr[0] + "," + arr[1] + "," + arr[2] + ")" +
            ")";
            this.customlog('setS_RGBColor', this.SBgColor);
        }
        setV_RGBColor(){
            var arr=this.HSVtoRGB(this.Hue/360, this.Saturation/100, 1);
            this.VBgColor="-webkit-linear-gradient(left,#ffffff," +
            "rgb(" + arr[0] + "," + arr[1] + "," + arr[2] + ")" +
            ")";
            this.customlog('setV_RGBColor', this.VBgColor);
        }

        setGradientBGcolor(){
         var s=this.hslToRGB(this.Hue,100,50);
         //s=this.getRgb2HSV();
         //const s=this.getRGBA();
        ...
        hexToRgbA(InputData) {
            ...
            try {
                ...
                var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(InputData);
                var RGBAcolor=[parseInt(result[1], 16), parseInt(result[2], 16), parseInt(result[3], 16),1 ];
                return result ?RGBAcolor: null;
            }
            catch{
                this.customlog("hexToRgbAError", InputData);
            }
        }
