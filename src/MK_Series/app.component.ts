...
export class AppComponent implements OnInit {
    ...
    constructor(
        ...
        let DataContent = {
            ...
            Func: this.Electron_Service.getFuncVar().FuncName.InitializeUIDone,//correspond electron.js in line 256 name register event 
            Param: ""
        }
    ...
    quitApp() {
        ...
        console.log('quitApp:', DataContent);
    ...
    i18nClickExcute() {
        ...
        this.system.isMac = this.Electron_Service.get_env().isMac;
    }
    ...
    readDBDataFromServer() {
        ...
        this.Electron_Service.development_SupportDB(data, setdata);
    ...
    ImportProfile() {
        ...
        switch (this.CurrentPageName) {
            ...
            case "MACROSETTINGS":
                ...
                break;
            case "RELATEDPROGRAM":
                typeName = this.Electron_Service.get_env().isMac ? "app" : "exe";
                break;
            case "Custom Effect":
                typeName = "Advanced"
                break;
        ...
        if (this.CurrentPageName == "RELATEDPROGRAM") {
            this.Electron_Service.getdialog().showOpenDialog(null, { defaultPath: '', filters: [{ name: typeName + ' File', extensions: [typeName] }] }, (fns) => {
                console.log('showOpenDialog:', typeName, fns);
                if (fns != undefined) {
                    console.log('讀取路徑fns', fns[0]);
                    //var TestText = "C:\\Users\\Louis\\Desktop\\5555.Macro";                    
                    var index = this.Electron_Service.get_env().isMac ? fns[0].lastIndexOf("/") : fns[0].lastIndexOf("\\");
        ...
        this.Electron_Service.getdialog().showOpenDialog(null,
            {
                defaultPath: '',
    ...
    ExportProfile() {
        ...
        this.Electron_Service.getdialog().showSaveDialog(null, {
            ...
            if (fns != undefined) {
                ...
                this.Electron_Service.get_tool().SaveFile(this.DeviceService.currentDevice.SN + '_Profile', data, fns, (err, result) => {
                    if (err) return
